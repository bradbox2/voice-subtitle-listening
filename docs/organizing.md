...
This fork offers three simple ways to organize your audiobooks based on how you store them on your device. Pick the option that matches your setup best:
...
The app recognizes three audiobooks: `TheHobbit`, `MobyDick`, and the single-file book `LittlePrince`.
...
The app recognizes one audiobook: `PrideAndPrejudice`.
...
The app recognizes authors (`Woolf`, `Tolkien`) and their audiobooks (`MrsDalloway`, `ToTheLighthouse`, `TheHobbit`).
